...
def get_args():
    ...
    ## itm transfomer setting
    parser.add_argument("--itm_depth", type=int, default=2, help="itm transformer self attn layers")

    ## mim transfomer setting
    parser.add_argument("--mim_depth", type=int, default=4, help="itm transformer self attn layers")

    ######################## loss settings ########################
    # parser.add_argument("--loss_names", default='sdm+id+mlm', help="which loss to use ['mlm', 'cmpm', 'id', 'itc', 'sdm']")
    parser.add_argument("--loss_names", default='sdm+gi2id+mim', help="which loss to use ['mlm', 'cmpm', 'id', 'itc', 'sdm']")
